...
const buildConfigs = [
    ...
    },
    {
        ...
        outfile: "dist/Coffecord.user.js",
        banner: {
...
async function buildExtension(target, files) {
    const entries = {
        "dist/Coffecord.js": await readFile("dist/browser/extension.js"),
        "dist/Coffecord.css": await readFile("dist/browser/extension.css"),
...
const appendCssRuntime = readFile("dist/Coffecord.user.css", "utf-8").then(content => {
    const cssRuntime = `
...
`;
    ...
    return appendFile("dist/Coffecord.user.js", cssRuntime);
});
